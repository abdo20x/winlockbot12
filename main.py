...
'''
===== BLUE LOCK RIVALS BOT =====
سجل التغييرات:
v1.0.0 - إطلاق النسخة الأولية
v1.1.0 - إضافة نظام الاقتصاد والعملات
v1.2.0 - إضافة نظام الفرق وإدارة اللاعبين
v1.3.0 - إضافة نظام التعاقدات وتحديد أسعار اللاعبين
v1.4.0 - إضافة أوامر الإدارة المخصصة لصاحب البوت
v2.0.0 - تحديث كبير يشمل نظام إحصائيات اللاعبين وطلبات الانضمام
v2.1.0 - تحسين نظام الفرق واستخدام قناة مخصصة للإشعارات
v2.2.0 - إضافة التأثيرات المتحركة للإعلان عن الانتقالات وشعارات الفرق
v2.3.0 - تطوير واجهة المستخدم بإضافة شعار النادي في جميع الرسائل
'''
    ...
    async def on_message(self, message):
        ...
        if self.user.mentioned_in(message) and not message.mention_everyone:
            help_text = (
                ...
                "• `/عرض_تفاصيل` - عرض معلومات الفرق واللاعبين بشكل مفصل\n\n"
